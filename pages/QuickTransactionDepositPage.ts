...
// Page Object for Quick Transactions — Deposit transaction type scope.
// Uses human-like pauses between field interactions for easy visual monitoring.

export class QuickTransactionDepositPage extends BasePage {
  ...
  async selectDepositTransactionType(): Promise<void> {
    await this.pause();
    await this.selectOption(this.transactionTypeDropdown, 'Deposit');
    await this.pause();
  }
  ...
  // ── Confirmation modal — verification getters ────────────────────────────────
  ...
  // ── Success screen — verification getters ────────────────────────────────────
